...
function Sidebar({ activeMenu, onMenuChange }: SidebarProps) {
  return (
    <aside className="w-sidebar bg-card border-r border-border flex flex-col items-center py-6 gap-4">
      {/* Logo */}
      <div className="mb-6">
      ...
      >
        ...
        <span className="text-xs font-medium">Parser</span>
      </button>
      ...
      >
        ...
        <span className="text-xs font-medium">Splitter</span>
      </button>
      ...
      >
        ...
        <span className="text-xs font-medium">VDB</span>
      </button>
      ...
      >
        ...
        <span className="text-xs font-medium">Eval</span>
      </button>
